...
1. Vá até a aba [Releases]([https://github.com](https://github.com/Darksider96/Oddsparks-Traducao-PTBR/releases/tag/v1.0.0)) deste repositório e baixe a versão mais recente do arquivo `Instalador_Traducao_Oddsparks_PTBR.exe`.
